...
(async () => {
  ...
  await pageMatches.goto('http://127.0.0.1:3011/matches', { waitUntil: 'domcontentloaded', timeout: 60000 });
  ...
  await pagePred.goto('http://127.0.0.1:3011/predictions', { waitUntil: 'domcontentloaded', timeout: 60000 });
